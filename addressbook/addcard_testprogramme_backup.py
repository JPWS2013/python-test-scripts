...
print 'To begin, please select an address book. Alternatively, you may view all your address books or perform a global search. Your options are shown below:'
print 
print '1. Create a New Address Book'
print '2. View all Address Books'
print '3. View 1 specific Address Book'
print '4. Retrieve a specific address book to edit'
print '5. Perform a global search on all address books'
print '6. Delete an Address Book'
print 
...
while mainmenuselect!='9': #Ensures the loop is continually run unless user selects 9 (exit option)
	...
	print '9. Quit Programme'
	print ' '

	mainmenuselect=raw_input('Please enter the number corresponding to the action you would like to perform:') #Request for user's choice
	print ' '

	if mainmenuselect=='1': #Option 1 executed
	...
	elif mainmenuselect=='2': #Code for second option
